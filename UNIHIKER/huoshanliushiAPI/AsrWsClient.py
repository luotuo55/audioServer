...
class AsrWsClient:
    def __init__(self, audio_path, cluster, **kwargs):
        ...
        self.show_utterances = kwargs.get("show_utterances", True)  # 设置为 True
        self.result_type = kwargs.get("result_type", "full")  # 设置为 "full"
...
async def test_one():
    result = await execute_one(
        ...
        token=token,
        format=audio_format,
        show_utterances=True,  # 设置为 True
        result_type="full"     # 设置为 "full"
    )
